...
export const translations: Readonly<Record<string, Readonly<Record<string, string>>>> =
...
export const defaultCenter: Readonly<{ lat: number; lng: number }> = {
  lat: 39.0,
  lng: 35.0,
} as const; // Turkey center
